    ...
    <>
      ...
      >
        ...
        <Box sx={{position:"relative",overflow:"hidden",borderRadius:"16px",width: { xs: "100%", md: "50%" },
          ...
          <Box sx={{background:"var(--primary)",position:"absolute",bottom:"0px",right:"0px",padding:"20px",color:"var(--white)",borderBottomRightRadius:"16px",borderTopLeftRadius:"6px",width:{ xs:"90%",sm:"70%",md:"60%",},zIndex:"8"}}>
            ...
            <Typography sx={{fontFamily:"Medium_M",fontSize:"14px",mt:"15px !important"}}>
                Helping individuals and businesses secure the right loans with confidence.
            </Typography>
          </Box>
        </Box>
        ...
        <Box sx={{ width: { xs: "100%", md: "50%" } }}>
          ...
          >
          We provide trusted, transparent, and result-driven loan consultancy services.
          </Typography>
                      {/* SHORT PARAGRAPH */}
          <Typography
            sx={{
          ...
          >
            We are a professional loan consultancy firm specializing in home loans, business loans, personal loans, and financial advisory services. Our mission is to simplify the loan process and help clients secure the best financing options with minimal hassle and maximum approval chances.
          </Typography>
          ...
          <Stack spacing={1.5} sx={{ mb: 3 }}>
            {[
              ...
              "Business & MSME Loans",
              "Personal Loans",
              "Loan Eligibility & Documentation Support",
            ].map((item, i) => (
...
>
  ...
  { label: "Loans Processed", value: 1200 },
  { label: "Financial Experts", value: 20 },
