...
>
  ...
  >
    ...
    {/* BUSINESS LOCATION */}
    <Box>
      <Typography sx={{ mb: 1 }}>Select Loan Type</Typography>
      <TextField
        select
        fullWidth
    ...
    helperText={errors.location?.message}
      >
        ...
        <option value="qatar">Mortgage Loan</option>
        <option value="india">Loan Against Property</option>
        <option value="india">Home Loan</option>
        <option value="india">Machinery Loan</option>
        <option value="india">Business Loan</option>
        <option value="india">Personal Loan</option>
      </TextField>
    </Box>
              ...
              <Box>
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    window.open(`https://wa.me/${commonWord.mobileNumber}?text=${message}`, "_blank");
                  }}
                >
                  Message on WhatsApp
                </Button>
